[perfect-graph](../README.md) / [Modules](../modules.md) / [components/GraphEditor/DataEditor](../modules/components_GraphEditor_DataEditor.md) / [<internal\>](../modules/components_GraphEditor_DataEditor._internal_.md) / AutocompleteProps
...
- [aria-details](components_GraphEditor_DataEditor._internal_.AutocompleteProps.md#aria-details)
...
- [componentsProps](components_GraphEditor_DataEditor._internal_.AutocompleteProps.md#componentsprops)
...
- [onAnimationStartCapture](components_GraphEditor_DataEditor._internal_.AutocompleteProps.md#onanimationstartcapture)
...
- [onDrop](components_GraphEditor_DataEditor._internal_.AutocompleteProps.md#ondrop)
...
- [onMouseOut](components_GraphEditor_DataEditor._internal_.AutocompleteProps.md#onmouseout)
...
- [onSeekingCapture](components_GraphEditor_DataEditor._internal_.AutocompleteProps.md#onseekingcapture)
...
- [suppressHydrationWarning](components_GraphEditor_DataEditor._internal_.AutocompleteProps.md#suppresshydrationwarning)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[open](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#open)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[openOnFocus](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#openonfocus)
...
node_modules/@mui/material/Autocomplete/Autocomplete.d.ts:174
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[options](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#options)
...
• `Optional` **popupIcon**: [`ReactNode`](../modules/components_ClusterNodeContainer._internal_.md#reactnode)
...
node_modules/@mui/material/Autocomplete/Autocomplete.d.ts:189
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[selectOnFocus](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#selectonfocus)
...
node_modules/@mui/material/Autocomplete/Autocomplete.d.ts:229
...
node_modules/@mui/material/Autocomplete/Autocomplete.d.ts:233
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[value](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#value)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[filterOptions](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#filteroptions)
...
▸ `Optional` **getLimitTagsText**(`more`): [`ReactNode`](../modules/components_ClusterNodeContainer._internal_.md#reactnode)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `more` | `number` | The number of truncated tags. |
...
node_modules/@mui/material/Autocomplete/Autocomplete.d.ts:132
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[getOptionDisabled](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#getoptiondisabled)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[getOptionLabel](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#getoptionlabel)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[groupBy](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#groupby)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[isOptionEqualToValue](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#isoptionequaltovalue)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[onChange](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#onchange)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[onClose](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#onclose)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[onHighlightChange](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#onhighlightchange)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[onInputChange](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#oninputchange)
...
[UseAutocompleteProps](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md).[onOpen](components_GraphEditor_DataEditor._internal_.UseAutocompleteProps.md#onopen)
...
▸ `Optional` **renderGroup**(`params`): [`ReactNode`](../modules/components_ClusterNodeContainer._internal_.md#reactnode)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `params` | [`AutocompleteRenderGroupParams`](components_GraphEditor_DataEditor._internal_.AutocompleteRenderGroupParams.md) | The group to render. |
...
node_modules/@mui/material/Autocomplete/Autocomplete.d.ts:196

___

### renderInput

▸ **renderInput**(`params`): [`ReactNode`](../modules/components_ClusterNodeContainer._internal_.md#reactnode)
...
| Name | Type |
| :------ | :------ |
| `params` | [`AutocompleteRenderInputParams`](components_GraphEditor_DataEditor._internal_.AutocompleteRenderInputParams.md) |
...
node_modules/@mui/material/Autocomplete/Autocomplete.d.ts:203

___

### renderOption

▸ `Optional` **renderOption**(`props`, `option`, `state`): [`ReactNode`](../modules/components_ClusterNodeContainer._internal_.md#reactnode)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `props` | [`HTMLAttributes`](components_Container._internal_.HTMLAttributes.md)<`HTMLLIElement`\> | The props to apply on the li element. |
| `option` | `T` | The option to render. |
| `state` | [`AutocompleteRenderOptionState`](components_GraphEditor_DataEditor._internal_.AutocompleteRenderOptionState.md) | The state of the component. |
...
node_modules/@mui/material/Autocomplete/Autocomplete.d.ts:212

___

### renderTags

▸ `Optional` **renderTags**(`value`, `getTagProps`): [`ReactNode`](../modules/components_ClusterNodeContainer._internal_.md#reactnode)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | `T`[] | The `value` provided to the component. |
| `getTagProps` | [`AutocompleteRenderGetTagProps`](../modules/components_GraphEditor_DataEditor._internal_.md#autocompleterendergettagprops) | A tag props getter. |
...
node_modules/@mui/material/Autocomplete/Autocomplete.d.ts:224
