[perfect-graph](../README.md) / [Modules](../modules.md) / [components/ClusterNodeContainer](../modules/components_ClusterNodeContainer.md) / [<internal\>](../modules/components_ClusterNodeContainer._internal_.md) / Buffer

# Interface: Buffer

[components/ClusterNodeContainer](../modules/components_ClusterNodeContainer.md).[<internal>](../modules/components_ClusterNodeContainer._internal_.md).Buffer
...
- [BYTES\_PER\_ELEMENT](components_ClusterNodeContainer._internal_.Buffer.md#bytes_per_element)
- [[toStringTag]](components_ClusterNodeContainer._internal_.Buffer.md#[tostringtag])
- [buffer](components_ClusterNodeContainer._internal_.Buffer.md#buffer)
- [byteLength](components_ClusterNodeContainer._internal_.Buffer.md#bytelength)
- [byteOffset](components_ClusterNodeContainer._internal_.Buffer.md#byteoffset)
- [length](components_ClusterNodeContainer._internal_.Buffer.md#length)

### Methods

- [[iterator]](components_ClusterNodeContainer._internal_.Buffer.md#[iterator])
- [at](components_ClusterNodeContainer._internal_.Buffer.md#at)
- [compare](components_ClusterNodeContainer._internal_.Buffer.md#compare)
- [copy](components_ClusterNodeContainer._internal_.Buffer.md#copy)
- [copyWithin](components_ClusterNodeContainer._internal_.Buffer.md#copywithin)
- [entries](components_ClusterNodeContainer._internal_.Buffer.md#entries)
- [equals](components_ClusterNodeContainer._internal_.Buffer.md#equals)
- [every](components_ClusterNodeContainer._internal_.Buffer.md#every)
- [fill](components_ClusterNodeContainer._internal_.Buffer.md#fill)
- [filter](components_ClusterNodeContainer._internal_.Buffer.md#filter)
- [find](components_ClusterNodeContainer._internal_.Buffer.md#find)
- [findIndex](components_ClusterNodeContainer._internal_.Buffer.md#findindex)
- [forEach](components_ClusterNodeContainer._internal_.Buffer.md#foreach)
- [includes](components_ClusterNodeContainer._internal_.Buffer.md#includes)
- [indexOf](components_ClusterNodeContainer._internal_.Buffer.md#indexof)
- [join](components_ClusterNodeContainer._internal_.Buffer.md#join)
- [keys](components_ClusterNodeContainer._internal_.Buffer.md#keys)
- [lastIndexOf](components_ClusterNodeContainer._internal_.Buffer.md#lastindexof)
- [map](components_ClusterNodeContainer._internal_.Buffer.md#map)
- [readBigInt64BE](components_ClusterNodeContainer._internal_.Buffer.md#readbigint64be)
- [readBigInt64LE](components_ClusterNodeContainer._internal_.Buffer.md#readbigint64le)
- [readBigUInt64BE](components_ClusterNodeContainer._internal_.Buffer.md#readbiguint64be)
- [readBigUInt64LE](components_ClusterNodeContainer._internal_.Buffer.md#readbiguint64le)
- [readDoubleBE](components_ClusterNodeContainer._internal_.Buffer.md#readdoublebe)
- [readDoubleLE](components_ClusterNodeContainer._internal_.Buffer.md#readdoublele)
- [readFloatBE](components_ClusterNodeContainer._internal_.Buffer.md#readfloatbe)
- [readFloatLE](components_ClusterNodeContainer._internal_.Buffer.md#readfloatle)
- [readInt16BE](components_ClusterNodeContainer._internal_.Buffer.md#readint16be)
- [readInt16LE](components_ClusterNodeContainer._internal_.Buffer.md#readint16le)
- [readInt32BE](components_ClusterNodeContainer._internal_.Buffer.md#readint32be)
- [readInt32LE](components_ClusterNodeContainer._internal_.Buffer.md#readint32le)
- [readInt8](components_ClusterNodeContainer._internal_.Buffer.md#readint8)
- [readIntBE](components_ClusterNodeContainer._internal_.Buffer.md#readintbe)
- [readIntLE](components_ClusterNodeContainer._internal_.Buffer.md#readintle)
- [readUInt16BE](components_ClusterNodeContainer._internal_.Buffer.md#readuint16be)
- [readUInt16LE](components_ClusterNodeContainer._internal_.Buffer.md#readuint16le)
- [readUInt32BE](components_ClusterNodeContainer._internal_.Buffer.md#readuint32be)
- [readUInt32LE](components_ClusterNodeContainer._internal_.Buffer.md#readuint32le)
- [readUInt8](components_ClusterNodeContainer._internal_.Buffer.md#readuint8)
- [readUIntBE](components_ClusterNodeContainer._internal_.Buffer.md#readuintbe)
- [readUIntLE](components_ClusterNodeContainer._internal_.Buffer.md#readuintle)
- [reduce](components_ClusterNodeContainer._internal_.Buffer.md#reduce)
- [reduceRight](components_ClusterNodeContainer._internal_.Buffer.md#reduceright)
- [reverse](components_ClusterNodeContainer._internal_.Buffer.md#reverse)
- [set](components_ClusterNodeContainer._internal_.Buffer.md#set)
- [slice](components_ClusterNodeContainer._internal_.Buffer.md#slice)
- [some](components_ClusterNodeContainer._internal_.Buffer.md#some)
- [sort](components_ClusterNodeContainer._internal_.Buffer.md#sort)
- [subarray](components_ClusterNodeContainer._internal_.Buffer.md#subarray)
- [swap16](components_ClusterNodeContainer._internal_.Buffer.md#swap16)
- [swap32](components_ClusterNodeContainer._internal_.Buffer.md#swap32)
- [swap64](components_ClusterNodeContainer._internal_.Buffer.md#swap64)
- [toJSON](components_ClusterNodeContainer._internal_.Buffer.md#tojson)
- [toLocaleString](components_ClusterNodeContainer._internal_.Buffer.md#tolocalestring)
- [toString](components_ClusterNodeContainer._internal_.Buffer.md#tostring)
- [valueOf](components_ClusterNodeContainer._internal_.Buffer.md#valueof)
- [values](components_ClusterNodeContainer._internal_.Buffer.md#values)
- [write](components_ClusterNodeContainer._internal_.Buffer.md#write)
- [writeBigInt64BE](components_ClusterNodeContainer._internal_.Buffer.md#writebigint64be)
- [writeBigInt64LE](components_ClusterNodeContainer._internal_.Buffer.md#writebigint64le)
- [writeBigUInt64BE](components_ClusterNodeContainer._internal_.Buffer.md#writebiguint64be)
- [writeBigUInt64LE](components_ClusterNodeContainer._internal_.Buffer.md#writebiguint64le)
- [writeDoubleBE](components_ClusterNodeContainer._internal_.Buffer.md#writedoublebe)
- [writeDoubleLE](components_ClusterNodeContainer._internal_.Buffer.md#writedoublele)
- [writeFloatBE](components_ClusterNodeContainer._internal_.Buffer.md#writefloatbe)
- [writeFloatLE](components_ClusterNodeContainer._internal_.Buffer.md#writefloatle)
- [writeInt16BE](components_ClusterNodeContainer._internal_.Buffer.md#writeint16be)
- [writeInt16LE](components_ClusterNodeContainer._internal_.Buffer.md#writeint16le)
- [writeInt32BE](components_ClusterNodeContainer._internal_.Buffer.md#writeint32be)
- [writeInt32LE](components_ClusterNodeContainer._internal_.Buffer.md#writeint32le)
- [writeInt8](components_ClusterNodeContainer._internal_.Buffer.md#writeint8)
- [writeIntBE](components_ClusterNodeContainer._internal_.Buffer.md#writeintbe)
- [writeIntLE](components_ClusterNodeContainer._internal_.Buffer.md#writeintle)
- [writeUInt16BE](components_ClusterNodeContainer._internal_.Buffer.md#writeuint16be)
- [writeUInt16LE](components_ClusterNodeContainer._internal_.Buffer.md#writeuint16le)
- [writeUInt32BE](components_ClusterNodeContainer._internal_.Buffer.md#writeuint32be)
- [writeUInt32LE](components_ClusterNodeContainer._internal_.Buffer.md#writeuint32le)
- [writeUInt8](components_ClusterNodeContainer._internal_.Buffer.md#writeuint8)
- [writeUIntBE](components_ClusterNodeContainer._internal_.Buffer.md#writeuintbe)
- [writeUIntLE](components_ClusterNodeContainer._internal_.Buffer.md#writeuintle)
...
Uint8Array.\_\_@toStringTag@484
...
• `Readonly` **buffer**: [`ArrayBufferLike`](../modules/components_ClusterNodeContainer._internal_.md#arraybufferlike)
...
▸ **[iterator]**(): [`IterableIterator`](components_ClusterNodeContainer._internal_.IterableIterator.md)<`number`\>
...
▸ **copyWithin**(`target`, `start`, `end?`): [`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer)
...
[`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer)
...
▸ **entries**(): [`IterableIterator`](components_ClusterNodeContainer._internal_.IterableIterator.md)<[`number`, `number`]\>
...
[`IterableIterator`](components_ClusterNodeContainer._internal_.IterableIterator.md)<[`number`, `number`]\>
...
▸ **fill**(`value`, `offset?`, `end?`, `encoding?`): [`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | `string` \| `number` \| [`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer) | What to search for. |
| `byteOffset?` | `number` | - |
| `encoding?` | [`BufferEncoding`](../modules/components_ClusterNodeContainer._internal_.md#bufferencoding) | - |
...
▸ **reverse**(): [`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `array` | [`ArrayLike`](components_ClusterNodeContainer._internal_.ArrayLike.md)<`number`\> | A typed or untyped array of values to set. |
...
▸ **slice**(`start?`, `end?`): [`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer)
...
▸ **sort**(`compareFn?`): [`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer)
...
▸ **subarray**(`start?`, `end?`): [`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer)
...
▸ **swap16**(): [`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer)
...
▸ **swap32**(): [`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer)
...
▸ **swap64**(): [`Buffer`](../modules/components_ClusterNodeContainer._internal_.md#buffer)
...
▸ **values**(): [`IterableIterator`](components_ClusterNodeContainer._internal_.IterableIterator.md)<`number`\>
