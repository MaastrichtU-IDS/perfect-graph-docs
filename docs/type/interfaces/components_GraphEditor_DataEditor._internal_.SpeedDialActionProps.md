[perfect-graph](../README.md) / [Modules](../modules.md) / [components/GraphEditor/DataEditor](../modules/components_GraphEditor_DataEditor.md) / [<internal\>](../modules/components_GraphEditor_DataEditor._internal_.md) / SpeedDialActionProps
...
- [aria-hidden](components_GraphEditor_DataEditor._internal_.SpeedDialActionProps.md#aria-hidden)
...
- [defaultChecked](components_GraphEditor_DataEditor._internal_.SpeedDialActionProps.md#defaultchecked)
...
- [onCanPlayCapture](components_GraphEditor_DataEditor._internal_.SpeedDialActionProps.md#oncanplaycapture)
...
- [onDurationChangeCapture](components_GraphEditor_DataEditor._internal_.SpeedDialActionProps.md#ondurationchangecapture)
...
- [onMouseOver](components_GraphEditor_DataEditor._internal_.SpeedDialActionProps.md#onmouseover)
...
- [onSeekingCapture](components_GraphEditor_DataEditor._internal_.SpeedDialActionProps.md#onseekingcapture)
...
- [title](components_GraphEditor_DataEditor._internal_.SpeedDialActionProps.md#title)
...
node_modules/@mui/material/SpeedDialAction/SpeedDialAction.d.ts:13
...
StandardProps.disableFocusListener
...
node_modules/@mui/material/SpeedDialAction/SpeedDialAction.d.ts:31
...
• `Optional` **title**: `boolean` \| [`ReactChild`](../modules/components_ClusterNodeContainer._internal_.md#reactchild) \| [`ReactFragment`](../modules/components_ClusterNodeContainer._internal_.md#reactfragment) \| [`ReactPortal`](components_ClusterNodeContainer._internal_.ReactPortal.md)
...
node_modules/@mui/material/SpeedDialAction/SpeedDialAction.d.ts:49

___

### tooltipPlacement

• `Optional` **tooltipPlacement**: ``"top"`` \| ``"right"`` \| ``"bottom"`` \| ``"left"`` \| ``"bottom-end"`` \| ``"bottom-start"`` \| ``"left-end"`` \| ``"left-start"`` \| ``"right-end"`` \| ``"right-start"`` \| ``"top-end"`` \| ``"top-start"``
...
node_modules/@mui/material/SpeedDialAction/SpeedDialAction.d.ts:40

___

### tooltipTitle

• `Optional` **tooltipTitle**: [`ReactNode`](../modules/components_ClusterNodeContainer._internal_.md#reactnode)

Label to display in the tooltip.

#### Defined in

node_modules/@mui/material/SpeedDialAction/SpeedDialAction.d.ts:44
...
| :------ | :------ | :------ |
| `event` | `Event` \| [`SyntheticEvent`](components_Container._internal_.SyntheticEvent.md)<`Element`, `Event`\> | The event source of the callback. |
...
node_modules/@mui/material/Tooltip/Tooltip.d.ts:120
...
StandardProps.onOpen

#### Defined in

node_modules/@mui/material/Tooltip/Tooltip.d.ts:126
