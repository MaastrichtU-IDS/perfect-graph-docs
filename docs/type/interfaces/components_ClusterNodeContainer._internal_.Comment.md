[perfect-graph](../README.md) / [Modules](../modules.md) / [components/ClusterNodeContainer](../modules/components_ClusterNodeContainer.md) / [<internal\>](../modules/components_ClusterNodeContainer._internal_.md) / Comment

# Interface: Comment

[components/ClusterNodeContainer](../modules/components_ClusterNodeContainer.md).[<internal>](../modules/components_ClusterNodeContainer._internal_.md).Comment

Textual notations within markup; although it is generally not visually shown, such comments are available to be read in the source view.

## Hierarchy

- [`CharacterData`](../modules/components_ClusterNodeContainer._internal_.md#characterdata)
...
- [ATTRIBUTE\_NODE](components_ClusterNodeContainer._internal_.Comment.md#attribute_node)
- [CDATA\_SECTION\_NODE](components_ClusterNodeContainer._internal_.Comment.md#cdata_section_node)
- [COMMENT\_NODE](components_ClusterNodeContainer._internal_.Comment.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](components_ClusterNodeContainer._internal_.Comment.md#document_fragment_node)
- [DOCUMENT\_NODE](components_ClusterNodeContainer._internal_.Comment.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](components_ClusterNodeContainer._internal_.Comment.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](components_ClusterNodeContainer._internal_.Comment.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](components_ClusterNodeContainer._internal_.Comment.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](components_ClusterNodeContainer._internal_.Comment.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](components_ClusterNodeContainer._internal_.Comment.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](components_ClusterNodeContainer._internal_.Comment.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](components_ClusterNodeContainer._internal_.Comment.md#document_type_node)
- [ELEMENT\_NODE](components_ClusterNodeContainer._internal_.Comment.md#element_node)
- [ENTITY\_NODE](components_ClusterNodeContainer._internal_.Comment.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](components_ClusterNodeContainer._internal_.Comment.md#entity_reference_node)
- [NOTATION\_NODE](components_ClusterNodeContainer._internal_.Comment.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](components_ClusterNodeContainer._internal_.Comment.md#processing_instruction_node)
- [TEXT\_NODE](components_ClusterNodeContainer._internal_.Comment.md#text_node)
- [baseURI](components_ClusterNodeContainer._internal_.Comment.md#baseuri)
- [childNodes](components_ClusterNodeContainer._internal_.Comment.md#childnodes)
- [data](components_ClusterNodeContainer._internal_.Comment.md#data)
- [firstChild](components_ClusterNodeContainer._internal_.Comment.md#firstchild)
- [isConnected](components_ClusterNodeContainer._internal_.Comment.md#isconnected)
- [lastChild](components_ClusterNodeContainer._internal_.Comment.md#lastchild)
- [length](components_ClusterNodeContainer._internal_.Comment.md#length)
- [nextElementSibling](components_ClusterNodeContainer._internal_.Comment.md#nextelementsibling)
- [nextSibling](components_ClusterNodeContainer._internal_.Comment.md#nextsibling)
- [nodeName](components_ClusterNodeContainer._internal_.Comment.md#nodename)
- [nodeType](components_ClusterNodeContainer._internal_.Comment.md#nodetype)
- [nodeValue](components_ClusterNodeContainer._internal_.Comment.md#nodevalue)
- [ownerDocument](components_ClusterNodeContainer._internal_.Comment.md#ownerdocument)
- [parentElement](components_ClusterNodeContainer._internal_.Comment.md#parentelement)
- [parentNode](components_ClusterNodeContainer._internal_.Comment.md#parentnode)
- [previousElementSibling](components_ClusterNodeContainer._internal_.Comment.md#previouselementsibling)
- [previousSibling](components_ClusterNodeContainer._internal_.Comment.md#previoussibling)
- [textContent](components_ClusterNodeContainer._internal_.Comment.md#textcontent)

### Methods

- [addEventListener](components_ClusterNodeContainer._internal_.Comment.md#addeventlistener)
- [after](components_ClusterNodeContainer._internal_.Comment.md#after)
- [appendChild](components_ClusterNodeContainer._internal_.Comment.md#appendchild)
- [appendData](components_ClusterNodeContainer._internal_.Comment.md#appenddata)
- [before](components_ClusterNodeContainer._internal_.Comment.md#before)
- [cloneNode](components_ClusterNodeContainer._internal_.Comment.md#clonenode)
- [compareDocumentPosition](components_ClusterNodeContainer._internal_.Comment.md#comparedocumentposition)
- [contains](components_ClusterNodeContainer._internal_.Comment.md#contains)
- [deleteData](components_ClusterNodeContainer._internal_.Comment.md#deletedata)
- [dispatchEvent](components_ClusterNodeContainer._internal_.Comment.md#dispatchevent)
- [getRootNode](components_ClusterNodeContainer._internal_.Comment.md#getrootnode)
- [hasChildNodes](components_ClusterNodeContainer._internal_.Comment.md#haschildnodes)
- [insertBefore](components_ClusterNodeContainer._internal_.Comment.md#insertbefore)
- [insertData](components_ClusterNodeContainer._internal_.Comment.md#insertdata)
- [isDefaultNamespace](components_ClusterNodeContainer._internal_.Comment.md#isdefaultnamespace)
- [isEqualNode](components_ClusterNodeContainer._internal_.Comment.md#isequalnode)
- [isSameNode](components_ClusterNodeContainer._internal_.Comment.md#issamenode)
- [lookupNamespaceURI](components_ClusterNodeContainer._internal_.Comment.md#lookupnamespaceuri)
- [lookupPrefix](components_ClusterNodeContainer._internal_.Comment.md#lookupprefix)
- [normalize](components_ClusterNodeContainer._internal_.Comment.md#normalize)
- [remove](components_ClusterNodeContainer._internal_.Comment.md#remove)
- [removeChild](components_ClusterNodeContainer._internal_.Comment.md#removechild)
- [removeEventListener](components_ClusterNodeContainer._internal_.Comment.md#removeeventlistener)
- [replaceChild](components_ClusterNodeContainer._internal_.Comment.md#replacechild)
- [replaceData](components_ClusterNodeContainer._internal_.Comment.md#replacedata)
- [replaceWith](components_ClusterNodeContainer._internal_.Comment.md#replacewith)
- [substringData](components_ClusterNodeContainer._internal_.Comment.md#substringdata)
