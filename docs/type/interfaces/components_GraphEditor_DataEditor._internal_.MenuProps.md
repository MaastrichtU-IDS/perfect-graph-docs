[perfect-graph](../README.md) / [Modules](../modules.md) / [components/GraphEditor/DataEditor](../modules/components_GraphEditor_DataEditor.md) / [<internal\>](../modules/components_GraphEditor_DataEditor._internal_.md) / MenuProps
...
- [aria-multiline](components_GraphEditor_DataEditor._internal_.MenuProps.md#aria-multiline)
...
- [itemProp](components_GraphEditor_DataEditor._internal_.MenuProps.md#itemprop)
...
- [onDragEnterCapture](components_GraphEditor_DataEditor._internal_.MenuProps.md#ondragentercapture)
...
- [onMouseMoveCapture](components_GraphEditor_DataEditor._internal_.MenuProps.md#onmousemovecapture)
...
- [onTimeUpdateCapture](components_GraphEditor_DataEditor._internal_.MenuProps.md#ontimeupdatecapture)
...
node_modules/@mui/material/Popover/Popover.d.ts:93

___

### PopoverClasses

• `Optional` **PopoverClasses**: [`Partial`](../modules/components_ClusterNodeContainer._internal_.md#partial)<[`PopoverClasses`](components_GraphEditor_DataEditor._internal_.PopoverClasses.md)\>

`classes` prop applied to the [`Popover`](/api/popover/) element.

#### Defined in

node_modules/@mui/material/Menu/Menu.d.ts:59
...
node_modules/@mui/material/Popover/Popover.d.ts:116
...
node_modules/@mui/material/Menu/Menu.d.ts:74
...
• `Optional` **action**: [`Ref`](../modules/components_Container._internal_.md#ref)<[`PopoverActions`](components_GraphEditor_DataEditor._internal_.PopoverActions.md)\>
...
node_modules/@mui/material/Popover/Popover.d.ts:27

___

### anchorEl

• `Optional` **anchorEl**: ``null`` \| `Element` \| (`element`: `Element`) => `Element`
...
StandardProps.anchorEl

#### Defined in

node_modules/@mui/material/Menu/Menu.d.ts:15

___

### anchorOrigin

• `Optional` **anchorOrigin**: [`PopoverOrigin`](components_GraphEditor_DataEditor._internal_.PopoverOrigin.md)
...
StandardProps.anchorOrigin

#### Defined in

node_modules/@mui/material/Popover/Popover.d.ts:46

___

### anchorPosition

• `Optional` **anchorPosition**: [`PopoverPosition`](components_GraphEditor_DataEditor._internal_.PopoverPosition.md)
...
StandardProps.anchorPosition

#### Defined in

node_modules/@mui/material/Popover/Popover.d.ts:51

___

### anchorReference

• `Optional` **anchorReference**: [`PopoverReference`](../modules/components_GraphEditor_DataEditor._internal_.md#popoverreference)
...
StandardProps.anchorReference

#### Defined in

node_modules/@mui/material/Popover/Popover.d.ts:57
...
node_modules/@mui/material/Menu/Menu.d.ts:23
...
node_modules/@mui/material/Menu/Menu.d.ts:27
...
• `Optional` **classes**: [`Partial`](../modules/components_ClusterNodeContainer._internal_.md#partial)<[`MenuClasses`](components_GraphEditor_DataEditor._internal_.MenuClasses.md)\>
...
node_modules/@mui/material/Menu/Menu.d.ts:31
...
StandardProps.closeAfterTransition

#### Defined in

node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:31
...
node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:37
...
| Name | Type |
| :------ | :------ |
| `root?` | [`HTMLAttributes`](components_Container._internal_.HTMLAttributes.md)<`HTMLDivElement`\> & [`ModalUnstyledComponentsPropsOverrides`](components_GraphEditor_DataEditor._internal_.ModalUnstyledComponentsPropsOverrides.md) |
...
node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:44
...
StandardProps.container

#### Defined in

node_modules/@mui/material/Popover/Popover.d.ts:73
...
StandardProps.disableAutoFocus

#### Defined in

node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:64

___

### disableAutoFocusItem

• `Optional` **disableAutoFocusItem**: `boolean`
...
node_modules/@mui/material/Menu/Menu.d.ts:39
...
StandardProps.disableEnforceFocus

#### Defined in

node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:72
...
StandardProps.disableEscapeKeyDown

#### Defined in

node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:77
...
StandardProps.disablePortal

#### Defined in

node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:82
...
StandardProps.disableRestoreFocus

#### Defined in

node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:88
...
StandardProps.disableScrollLock

#### Defined in

node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:93
...
node_modules/@mui/material/Popover/Popover.d.ts:78
...
StandardProps.hideBackdrop

#### Defined in

node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:98
...
StandardProps.keepMounted

#### Defined in

node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:105
...
• `Optional` **marginThreshold**: `number`
...
StandardProps.marginThreshold

#### Defined in

node_modules/@mui/material/Popover/Popover.d.ts:83
...
• `Optional` **onBackdropClick**: [`ReactEventHandler`](../modules/components_Container._internal_.md#reacteventhandler)<{}\>

Callback fired when the backdrop is clicked.

#### Inherited from

StandardProps.onBackdropClick

#### Defined in

node_modules/@mui/core/ModalUnstyled/ModalUnstyled.d.ts:109
...
| `reason` | ``"backdropClick"`` \| ``"escapeKeyDown"`` | Can be: `"escapeKeyDown"`, `"backdropClick"`, `"tabKeyDown"`. |
...
StandardProps.onClose

#### Defined in

node_modules/@mui/material/Menu/Menu.d.ts:51
...
node_modules/@mui/material/Menu/Menu.d.ts:55
...
node_modules/@mui/material/Menu/Menu.d.ts:63
...
• `Optional` **transformOrigin**: [`PopoverOrigin`](components_GraphEditor_DataEditor._internal_.PopoverOrigin.md)
...
StandardProps.transformOrigin

#### Defined in

node_modules/@mui/material/Popover/Popover.d.ts:110
...
StandardProps.transitionDuration

#### Defined in

node_modules/@mui/material/Menu/Menu.d.ts:68
...
node_modules/@mui/material/Menu/Menu.d.ts:79
